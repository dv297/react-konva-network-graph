    ...
    51: function(module, __webpack_exports__, __webpack_require__) {
      ...
      (NetworkGraph.__docgenInfo = {
        ...
        props: {
          ...
          width: { type: { name: 'number' }, required: !0, description: 'The width of the canvas.' },
          height: { type: { name: 'number' }, required: !0, description: 'The height of the canvas.' },
          renderNode: {
            type: { name: 'func' },
            required: !0,
            description:
          ...
          nodeWidth: {
            type: { name: 'number' },
            required: !0,
            description: 'The width of each node. Used to calculate where to place the connection for the edge.',
          },
          nodeHeight: {
            type: { name: 'number' },
            required: !0,
            description: 'The height of each node. Used to calculate where to place the connection for the edge.',
          },
        },
      }),
        'undefined' != typeof STORYBOOK_REACT_CLASSES &&
...
//# sourceMappingURL=main.17dc6d0e13cebc24355f.bundle.js.map
